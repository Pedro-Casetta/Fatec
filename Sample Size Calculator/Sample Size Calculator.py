...
# configure workspace
Aplicativo = Tk()
Aplicativo.title("Sample Size Calculator")
...
def calculo():
    if EN.get().isdigit() == False:
        messagebox.showerror(title = "Error", message = "Enter a numerical value in 'Population Size' field!")
    if EE.get().isdigit() == False:
        messagebox.showerror(title = "Error", message = "Enter a numerical value in 'Margin of Error' field!")
    ...
    resposta = Label(Aplicativo, text = f"Sample Size: {n:.0f}", bg = "#000000", fg = "#09ff00").grid(row = 5, columnspan = 3, pady = (20,10))
    return resposta
...
global itens3
global itens4
LN = Label(Aplicativo, text = "Population Size:", pady = 30, bg = "#000000", fg = "#09ff00")
itens1 = StringVar()
EN = Entry(Aplicativo, textvariable = itens1)
EN.config(bg = "#000000", fg = "#09ff00", insertbackground = "#09ff00")
LZ = Label(Aplicativo, text = "Confidence Level:", pady = 30, bg = "#000000", fg = "#09ff00")
itens2 = StringVar()
itens2.set("90%")
...
LP = Label(Aplicativo, text= "Population Proportion (%):", pady = 30, bg = "#000000", fg = "#09ff00")
itens3 = StringVar()
...
EP.bind("<Leave>", sair)
LE = Label( Aplicativo, text = "Margin of Error (%):", pady = 40, bg = "#000000", fg = "#09ff00")
itens4 = StringVar()
...
# button territory
Calcular = Button(Aplicativo, text = "Calculate", command = calculo, pady = 10, bg = "#000000", fg = "#09ff00", activebackground = "#0045FF")
Limpar = Button(Aplicativo, text = "Clear", command = limpar, pady = 10, bg = "#000000", fg = "#09ff00", activebackground = "#FF0000")

# Position Provide territory
LN.grid(row = 0, column = 0, padx = (90,0))
